...
constexpr inline auto write_some = write_some_ns::Function {};
}

namespace di::concepts {
template<typename T>
concept AsyncWritable = concepts::Callable<execution::write_some_ns::Function, T&, vocab::Span<byte const>>;
}
